...
protected:
  ...
  std::thread
      com_thread_; // thread which performs read and write as fast as possible

  bool hard_estopped =
      false; // variable to track if the hardware returned an estop condition
  bool soft_estopped =
      false; // variable to make sure we can come out of estop after an event
