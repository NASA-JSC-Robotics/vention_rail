...
#define VENTION_RAIL_HARDWARE_INTERFACE_PUBLIC VENTION_RAIL_HARDWARE_INTERFACE_EXPORT
#else
#define VENTION_RAIL_HARDWARE_INTERFACE_PUBLIC VENTION_RAIL_HARDWARE_INTERFACE_IMPORT
#endif
#define VENTION_RAIL_HARDWARE_INTERFACE_PUBLIC_TYPE VENTION_RAIL_HARDWARE_INTERFACE_PUBLIC
#define VENTION_RAIL_HARDWARE_INTERFACE_LOCAL
#else
#define VENTION_RAIL_HARDWARE_INTERFACE_EXPORT __attribute__((visibility("default")))
#define VENTION_RAIL_HARDWARE_INTERFACE_IMPORT
#if __GNUC__ >= 4
#define VENTION_RAIL_HARDWARE_INTERFACE_PUBLIC __attribute__((visibility("default")))
#define VENTION_RAIL_HARDWARE_INTERFACE_LOCAL __attribute__((visibility("hidden")))
#else
